...
lightTypes["LLC010"] = {
    "v1_static": {
        ...
        "capabilities": {
            "certified": True,
            "control": {
                "colorgamut": [[0.704, 0.296], [0.215, 0.711], [0.138, 0.08]],
                "colorgamuttype": "A",
                "maxlumen": 600,
                "mindimlevel": 5000
            },
...
lightTypes["LCX002"] = {
    "v1_static": {
        "type": "Extended color light",
        "manufacturername": "Signify Netherlands B.V.",
        "productname": "Hue play gradient lightstrip",
        "swversion": "1.104.2",
        "swconfigid": "C74E5108",
        "productid": "Philips-LCX002-1-LedStripPXv1",
        "swupdate": {
            "state": "noupdates",
            "lastinstall": "2020-11-02T19:46:12"
        },
        "capabilities": {
            "certified": True,
            "control": {
...
## Hue Signe Gradient
lightTypes["915005987201"] = {
    "v1_static": {
        "type": "Extended color light",
        "manufacturername": "Signify Netherlands B.V.",
        "productname": "Signe gradient floor",
        "swversion": "1.94.2",
        "swconfigid": "DC0A18AF",
        "productid": "4422-9482-0441_HG01_PSU03",
        "swupdate": {
            "state": "noupdates",
            "lastinstall": "2022-01-13T22:54:51"
        },
        "capabilities": {
            "certified": True,
            "control": {
    ...
    "device": {
        ...
        "manufacturer_name": "Signify Netherlands B.V.",
        "model_id": "915005987201",
        "product_archetype": "hue_signe",
        "product_name": "Signe gradient floor",
